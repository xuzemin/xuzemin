...
public class ZB_DeskAdapter extends BaseAdapter {
    Context context;
    List<Map<String, Object>> list;
    private boolean isState = false;

    public ZB_DeskAdapter(Context _context, List<Map<String, Object>> _list) {
        this.list = _list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ArrayList<Boolean> list_cb = ((ZB_MainActivity) context).getSelectItems();
        // 如果缓存convertView为空，则需要创建View
        if (convertView == null) {
            // 根据context上下文加载布局，这里的是AreaAdapter本身，即this
            final LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.zb_desk_item, null);
