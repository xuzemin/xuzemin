...
import com.android.zbrobot.activity.ZB_AreaRedact;
 ...
 * 描述: 区域名称适配器
 */
public class ZB_SpinnerAdapter2 extends BaseAdapter {
    Context context;
    List<Map> list;

    public ZB_SpinnerAdapter2(Context _context, List<Map> _list) {
        this.list = _list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (position == ZB_AreaRedact.moreDeskNum) {
