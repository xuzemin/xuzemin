...
import com.android.zbrobot.activity.ZB_AreaConfig;
...
public class ZB_AreaConfigAdapter extends BaseAdapter {
    Context context;
    List<Map> list;

    public ZB_AreaConfigAdapter(Context _context, List<Map> _list) {
        this.list = _list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (position == ZB_AreaConfig.Current_position) {
