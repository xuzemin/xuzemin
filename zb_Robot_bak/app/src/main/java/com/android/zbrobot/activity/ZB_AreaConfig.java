...
import com.android.zbrobot.adapter.ZB_AreaConfigAdapter;
...
public class ZB_AreaConfig extends Activity implements View.OnClickListener {
    // 区域信息适配器
    private ZB_AreaConfigAdapter myAdapter;
    // 加载区域列表
    ...
    protected void onResume() {
        ...
        // 显示到List列表上
        myAdapter = new ZB_AreaConfigAdapter(this, area_list);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.add_card:
                ...
                Intent intent = new Intent(ZB_AreaConfig.this, ZB_CardConfigActivity.class);
