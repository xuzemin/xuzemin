...
public class Constant {
    ...
    public static final String ROS_IP = "192.168.88.101";
    ...
    public static final int INTENET = 3;
    static String IP = "";
    ...
    //路线配置
    public static final String PATHCONFIG = "PATHCONFIG";
...
//    //测试用WI-FI02
//    public static String wifiname = "B-Link_BD6294";
//    public static String password = "88391477";
