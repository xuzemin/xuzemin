...
public class FinalHttp {
	private final static String LOG_TAG = "FinalHttp";
	private static final int DEFAULT_SOCKET_BUFFER_SIZE = 10 * 1024; // 8KB
	...
	// ------------------get 请求-----------------------
	public static void get_static(String url,
			AjaxCallBack<? extends Object> callBack) {
		LogUtil.i(LOG_TAG, "url:"+url);
		new FinalHttp().get(url, callBack);
