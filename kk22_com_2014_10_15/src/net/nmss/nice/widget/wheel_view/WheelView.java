...
package net.nmss.nice.widget.wheel_view;
...
public class WheelView extends View {
	...
	public WheelView(Context context, AttributeSet attrs) {
		...
		currentItem = a.getInteger(R.styleable.WheelView_currentItem, 0);
		visibleItems = a.getInteger(R.styleable.WheelView_visibleItems, DEF_VISIBLE_ITEMS);
		TEXT_SIZE = a.getDimensionPixelOffset(R.styleable.WheelView_textSize, 16);
