...
public class GetDiamondActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_getdiamond);
	...
	public class DiamAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(GetDiamondActivity.this).inflate(
						R.layout.activity_getdiamond_item, null);
