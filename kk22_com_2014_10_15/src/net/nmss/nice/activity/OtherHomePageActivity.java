...
public class OtherHomePageActivity extends BaseActivity implements
		OnRefreshListener2<ListView> {
	private final static String LOG_TAG = "OtherHomePageActivity";
	...
	private void initView() {
		...
		View view = View.inflate(this, R.layout.otherhomepage_head_layout, null);
		RoundImageView headImg = (RoundImageView) view
				.findViewById(R.id.otherhomepage_head_img);

		TextView userName = (TextView) view
				.findViewById(R.id.otherhomepage_head_name);
		TextView userDeclaration = (TextView) view
				.findViewById(R.id.otherhomepage_head_declaration);
	...
	public void doClick(View v){
		switch (v.getId()) {
		case R.id.otherhomepage_attend_btn:
			
			break;
			
		case R.id.otherhomepage_fans_lt:
			break;

		case R.id.otherhomepage_friends_lt:
			break;
				...
				new AsyncHttpResponseHandler() {
					...
					public void onFailure(int statusCode, Throwable error,
						...
						LogUtil.i(LOG_TAG, "firstPageHandler -> onFailure:"
								+ content);
						Toast.makeText(OtherHomePageActivity.this, "网络不给力...", Toast.LENGTH_SHORT)
								.show();
					}
	...
	private void parseHomeAgeListResponseJson(String jsonStr, boolean isAppend) {
		try {
			...
			if (r_e != 0) {
				Toast.makeText(OtherHomePageActivity.this,
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case 0:
				adapter = new MyHomePageAdapter(OtherHomePageActivity.this, bean);
