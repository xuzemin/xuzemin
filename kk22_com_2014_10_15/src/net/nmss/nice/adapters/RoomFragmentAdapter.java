...
import net.nmss.nice.activity.MyHomePageActivity;
import net.nmss.nice.activity.OtherHomePageActivity;
import net.nmss.nice.activity.PhotoViewActivity;
import net.nmss.nice.activity.RoomCommentActivity;
import net.nmss.nice.bean.MsgForPDBean;
