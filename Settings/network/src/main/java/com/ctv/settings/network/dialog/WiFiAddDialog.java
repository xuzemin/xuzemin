...
//        w.setAttributes(lp);
    ...
    private void findViews() {
        wifi_add_ssid_edt = findViewById(R.id.wifi_add_ssid_edt);
        wifi_add_pwd_edt = findViewById(R.id.wifi_add_pwd_edt);
        wifi_add_secure_sele_tv = findViewById(R.id.wifi_add_secure_sele_tv);
        wifi_add_show_pwd_tv = findViewById(R.id.wifi_add_show_pwd_tv);
        wifi_add_secure_tv = findViewById(R.id.wifi_add_secure_tv);
        wifi_add_ssid_tv = findViewById(R.id.wifi_add_ssid_tv);
        wifi_add_pwd_tv = findViewById(R.id.wifi_add_pwd_tv);
        wifi_add_show_pwd_iv = findViewById(R.id.wifi_add_show_pwd_iv);
        wifi_add_secure_iv = findViewById(R.id.wifi_add_secure_iv);
        wifi_add_show_pwd_fl = findViewById(R.id.wifi_add_show_pwd_fl);
...
//        wifiManager.connect(config, mConnectListener);
    ...
    private void setPwdVisibility() {
        if (mSecureType == NetUtils.SECURE_OPEN) {
            wifi_add_save_btn.setClickable(true);
            wifi_add_save_btn.setFocusable(true);
            wifi_add_save_btn.setBackgroundResource(R.drawable.shape_btn_bg_unselect);
            wifi_add_save_btn.setTextColor(ctvContext.getResources().getColor(R.color.white_seven));
            ...
            wifi_add_save_btn.setClickable(false);
            wifi_add_save_btn.setFocusable(false);
            wifi_add_save_btn.setTextColor(ctvContext.getResources().getColor(R.color.gray));
            wifi_add_save_btn.setBackgroundResource(R.drawable.shape_bg_accessibilit);
    ...
    public void onFocusChange(View view, boolean has_focus) {
        ...
        if (i == R.id.wifi_add_ssid_edt) {
            ...
            if (has_focus) {
                wifi_add_save_btn.setBackgroundResource(R.drawable.shape_btn_bg);
                wifi_add_save_btn.setTextColor(ctvContext.getResources()
                        .getColor(R.color.white));
            } else {
                wifi_add_save_btn.setBackgroundResource(R.drawable.shape_btn_bg_unselect);
                wifi_add_save_btn.setTextColor(ctvContext.getResources().getColor(
                        R.color.white_seven));
            }
        } else if (i == R.id.wifi_add_cancle_btn) {
            if (has_focus) {
        ...
        public void afterTextChanged(Editable s) {
            if (mSecureType != NetUtils.SECURE_OPEN) {
                if (wifi_add_pwd_edt.getText().length() >= 8) {
                    ...
                    wifi_add_save_btn.setFocusable(false);
                    wifi_add_save_btn
                            .setTextColor(ctvContext.getResources().getColor(R.color.gray));
                    wifi_add_save_btn.setBackgroundResource(R.drawable.shape_bg_accessibilit);
                }
            }
        }
