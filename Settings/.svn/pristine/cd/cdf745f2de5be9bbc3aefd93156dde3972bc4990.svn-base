...
//        w.setAttributes(lp);
    ...
    private void findViews() {
        ...
        wifi_cn_save_btn.setClickable(false);
        wifi_cn_save_btn.setFocusable(false);
        wifi_cn_save_btn.setTextColor(ctvContext.getResources().getColor(R.color.gray));
        wifi_cn_save_btn.setBackgroundResource(R.drawable.shape_bg_accessibilit);
    ...
    private void initData() {
        ...
        if (selectSsid.equals(wifiInfo.getSSID().replace("\"", ""))
            ...
            if (mSecureType == NetUtils.SECURE_OPEN) {
                wifi_cn_save_btn.setClickable(true);
                wifi_cn_save_btn.setFocusable(true);
                wifi_cn_save_btn.setBackgroundResource(R.drawable.shape_btn_bg_unselect);
                wifi_cn_save_btn.setTextColor(ctvContext.getResources().getColor(
                        R.color.white_seven));
                wifi_cn_pwd_fl.setVisibility(View.GONE);
                wifi_cn_show_pwd_fl.setVisibility(View.GONE);
            } else {
    ...
    private void setStaticIpButtonChanged(boolean isStaticIP) {
        if (isStaticIP) {
            ...
            wifi_cn_save_btn.setFocusable(true);
            wifi_cn_save_btn.setBackgroundResource(R.drawable.shape_btn_bg_unselect);
            wifi_cn_save_btn.setTextColor(ctvContext.getResources().getColor(R.color.white_seven));
            wifi_cn_forget_btn.setVisibility(View.GONE);
...
//                mStaticIpConfiguration, mHttpProxy));
    ...
    public void onFocusChange(View view, boolean has_focus) {
        ...
        if (i == R.id.wifi_cn_pwd_edt) {
            ...
            if (has_focus) {
                wifi_cn_save_btn.setBackgroundResource(R.drawable.shape_btn_bg);
                wifi_cn_save_btn
                        .setTextColor(ctvContext.getResources().getColor(R.color.white));
            } else {
                wifi_cn_save_btn.setBackgroundResource(R.drawable.shape_btn_bg_unselect);
                wifi_cn_save_btn.setTextColor(ctvContext.getResources().getColor(
                        R.color.white_seven));
