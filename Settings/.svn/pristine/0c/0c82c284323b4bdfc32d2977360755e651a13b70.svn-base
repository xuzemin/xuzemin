...
public class ConnectivityListener {
     ...
     */
        ...
        try {
            if (NetUtils.isNetworkSupported(mConnectivityManager)) {
...
//        UserHandle.getUserHandle(UserHandle.ALL);
    ...
    public void forgetWifiNetwork() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
