    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(ctvContext).inflate(R.layout.page_bluetooth_item,
                    parent, false);
            mHolder.bluetooth_name_tv = convertView.findViewById(R.id.bluetooth_name_tv);
            mHolder.bluetooth_address_tv = convertView.findViewById(R.id.bluetooth_address_tv);

            mHolder.bluetooth_connecting_tv = convertView
                    .findViewById(R.id.bluetooth_connecting_tv);
            mHolder.bluetooth_type_img = convertView.findViewById(R.id.bluetooth_type_img);
