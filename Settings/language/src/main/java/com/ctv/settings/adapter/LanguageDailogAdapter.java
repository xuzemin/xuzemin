...
package com.ctv.settings.adapter;
...
import com.ctv.settings.utils.SystemPropertiesNew;
...
public class LanguageDailogAdapter extends BaseAdapter {
    ...
    public View getView(int position, View contentview, ViewGroup parent) {
        ...
        language_dialog_item_tv.setText(language_strings[position]);
        ImageView language_dialog_item_ivs = (ImageView) contentview
                .findViewById(R.id.language_dialog_item_ivs);
        if (position == select) {
            language_dialog_item_ivs.setBackgroundResource(R.mipmap.selector_focus);
        } else {
