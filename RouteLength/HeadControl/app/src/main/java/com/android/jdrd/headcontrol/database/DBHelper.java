...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "headControl.db";
...
//        db.execSQL("create table headControl (_id integer primary key autoincrement,name varchar(20),phone varchar(11))");
        db.execSQL("create table table1(_id integer primary key autoincrement,state_time01 varchar(20),end_time02 varchar(11),kai_guan varchar(2))");
    }
