...
import com.android.zbrobot.adapter.GroupAdapter;
import com.android.zbrobot.util.Constant;
import com.android.zbrobot.util.ImageBean;

public class ZB_ImageChoose extends Activity{
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SCAN_OK:
                    ...
                    adapter = new GroupAdapter(ZB_ImageChoose.this, list = subGroupOfImage(mGruopMap), mGroupGridView);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGroupGridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent mIntent = new Intent(ZB_ImageChoose.this, ZB_ShowImage.class);
    ...
    public void getImage(){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                ContentResolver mContentResolver = ZB_ImageChoose.this.getContentResolver();
                Cursor mCursor = null;
                //只查询jpeg和png的图片
                try {
