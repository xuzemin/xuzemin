...
import com.android.zbrobot.adapter.ZB_CardAdapter;
...
public class ZB_CardConfig extends Activity implements View.OnClickListener {
    // 系统卡适配器
    private ZB_CardAdapter myAdapter;
    // 卡列表
    ...
    protected void onResume() {
        ...
        myAdapter = new ZB_CardAdapter(this, card_list);
        // 加载适配器
