...
public class UrlHelper {
	...
	// public static final String IMAGEPATH = "ImageResizer/Resetpic";
	// public static final String GIFTIMAGEPATH = "upload/gift_pic/temp/";
	 ...
	 * 我的瘦身问答详情
	 */
	public static final String GET_QUESTION_DETAIL = "newsApp/getQuestionDetail"; 
	 ...
	 * 瘦身问答
	 */
	public static final String GET_QUESTIONLISTS = "NewsApp/getQuestionList";

	/**
	 * 减肥知识某条记录的详细信息 /yes/getNews
	 */

	public static final String GET_LOSS_WEIGHT_KNOWLEDGE_DETAILS = "yes/getNews";

	/**
	 * /yes/getNewsLists 减肥知识列表
	 */
	 ...
	 * 注册
	 */
	public static final String REGISTER = "NewsApp/newAppRegister";
	/**
	 * 冷笑话/胖酷图
	 */
	 ...
	 * 朋友圈
	 */
	public static final String FRIENDROOM = "newsApp/getFriendDetail";
	/**
	 * 上传照片
	 */
	 ...
	 * 用户信息
	 */
	public static final String USERINFO = "NewsApp/getSpaceInfo";
	/**
	 * 提交用户信息
	 */
	 ...
	 * 提交用户手机
	 */
	public static final String UPDATETELE = "newsApp/updateInfo";
	/**
	 * 注册时提交用户信息
	 */
	public static final String REGISTERUSERINFO = "newsApp/newAppUpdateUserInfo";
	/**
	 * 修改密码
	 */
	 ...
	 * 是否关注
	 */
	public static final String ISRELATION = "NewsApp/yesOrRelation";
	/**
	 * 联系客服
	 */
	 ...
	 * 用户心情列表
	 */
	public static final String MOODLIST = "newsApp/moodList";
	/**
	 * 动态图
	 */
	public static final String MOODHEADER = "NewsApp/getPic";
	/**
	 * 搜索减肥问题
	 */
	public static final String LOSSQUESTION = "newsApp/searchNews";
	/**
	 * 我的好友
	 */
	 ...
	 * 判断是否有动态
	 */
	public static final String GETMSG = "newsApp/getQuestionMsg";
	/**
	 * 动态已读
	 */
	public static final String GETSTATUS = "newsApp/restStatus";
	/**
	 * 判断是否有新粉丝
	 */
	public static final String GETFANS = "newsApp/getRelationMsg";
	/**
	 * 动态已读
	 */
	public static final String GETSFANSTATUS = "newsApp/restRelStatus";

	public static String[] generateStringArrs(String... params) {
		return params;
	}

	public static String generateDefaultHostUrl(String urlPath) {
		return generateUrl(HOST, urlPath, null, null);
	}

	public static String generateDefaultHostUrl(String urlPath,
			String[] params, String[] values) {
		return generateUrl(HOST, urlPath, params, values);
	}

	public static String generateUrl(String host, String urlPath,
			String[] params, String[] values) {
		if (host == null || params != null && values != null
				&& params.length != values.length)
			throw new RuntimeException(
					"host equal null, or UrlHelpers params length not equal values length");
		...
		String urlStr = url.toString().replaceAll("&&", "&")
				.replaceAll("\\?\\?", "\\" + "?");
		LogUtil.e("UrlHelpers", "url=========>>>>" + urlStr);
		return urlStr;
	}

	public static String generateImageUrl(String host, String urlPath,
			String[] params, String[] values) {
		return generateUrl(host, urlPath, params, values);
	}

	public static String getAbsoluteUrl(String relativeUrl) {
		return UrlHelper.HOST + relativeUrl;
	}

	public static String[] generateStringArrs(String valueOf, String sendText,
			int type) {
		// TODO 自动生成的方法存根
		return null;
	}
