...
public final class Constantbaks {
    ...
    public static final int[] mCategoryIcons = new int[] {
            ...
            R.drawable.ic_car, R.drawable.ic_manufacture, R.drawable.ic_clothing,
            R.drawable.ic_building, R.drawable.ic_tobacco, R.drawable.ic_custom
    };
    ...
    public static final int[] mCategorySelIcons = new int[] {
            ...
            R.drawable.ic_car_selected, R.drawable.ic_manufacture_selected,
            R.drawable.ic_clothing_selected, R.drawable.ic_building_selected,
            R.drawable.ic_tobacco_selected, R.drawable.ic_custom_selected
    };
    ...
    public static final int[] mCategoryTitles = new int[] {
            ...
            R.string.ad, R.string.traffic, R.string.car, R.string.manufacture, R.string.clothing,
            R.string.building, R.string.tobacco, R.string.custom
    };
