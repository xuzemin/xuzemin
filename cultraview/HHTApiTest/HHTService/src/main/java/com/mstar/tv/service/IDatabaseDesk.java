...
public interface IDatabaseDesk {
    ...
    public enum EN_MS_VIDEOITEM {
        E_BRIGHTNESS, E_CONTRAST, E_SATURATION, E_SHARPNESS, E_HUE, E_BACKLIGHT, E_NUM,
    }
    ...
    public class PeqSetting {
        ...
        public PeqSetting() {
            int i = 0;
            peqParams = new PeqParameter[FactoryManager.PEQ_BAND_NUM];
            for (i = 0; i < FactoryManager.PEQ_BAND_NUM; i++) {
