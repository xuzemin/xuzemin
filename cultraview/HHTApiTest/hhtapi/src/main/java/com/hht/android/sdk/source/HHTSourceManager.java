...
public class HHTSourceManager {
    ...
    // 信号源List
    public static final String[] SOURCE_LIST = new String[]{
            DTV, ATV, VGA1, VGA2, VGA3,
            OPS, OPS2, HDMI1, HDMI2, HDMI3,
            HDMI4, HDMI5, HDMI6, TYPEC, TYPEC2,
            DP, DP2, AV1, AV2, YPBPR1, YPBPR2,
            ANDROID, STORAGE
    };
