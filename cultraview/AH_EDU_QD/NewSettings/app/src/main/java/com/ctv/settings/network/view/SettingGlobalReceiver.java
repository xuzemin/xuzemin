...
package com.ctv.settings.network.view;
...
public class SettingGlobalReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG, "action onReceive : " + action);
        if (action.equals("android.intent.action.BOOT_COMPLETED")) {
            proAutoDial(context);
        }
    }

    private void proAutoDial(Context context) {
        boolean flag = Tools.getBooleanPref(context, NetUtils.PPPOE_IS_AUTO_DIALER, false);
        Log.d(TAG, "pppoe auto dialer flag : " + flag);
        if (flag) {
            pppoeAutoDial(context);
        }
    }

    private void pppoeAutoDial(Context context) {
//        PppoeManager pppoe = PppoeManager.getInstance(context);
