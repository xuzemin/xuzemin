...
import com.ctv.settings.security.permission.ApplicationsState;

import java.util.List;

public class AppInstallPermissionListAadpter extends BaseAdapter {
    ...
    public AppInstallPermissionListAadpter(Context context, List<PermissionBean> packages) {
