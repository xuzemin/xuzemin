...
public class ThemeStyleAdapter extends BaseQuickAdapter<ThemeBgItem, BaseViewHolder> {
...
//        Glide.with( mContext ).load( item.getImageResource() ).thumbnail(0.1f).into( (ImageView) helper.getView(R.id.icon) ) ;
