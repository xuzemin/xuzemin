...
public class LocalUpdateActivity extends BaseActivity implements View.OnFocusChangeListener , View.OnClickListener {
...
//                    local_update_ok.setFocusable(false);
                    local_update_ok.setVisibility(View.INVISIBLE);
...
//                    local_update_ok.setFocusable(true);
                    local_update_ok.setVisibility(View.VISIBLE);
//                    local_update_ok.setBackgroundResource(R.drawable.selector_btn_bg);
...
//          Tools.setThemeByTime(context);
        ...
        viewById = (TextView) findViewById(R.id.back_title);
        viewById.setText(getResources().getString(R.string.local_update));
