...
public class DownLoading extends View implements Runnable{
    ...
    public DownLoading(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DownLoading(Context context, AttributeSet attrs, int defStyleAttr) {
