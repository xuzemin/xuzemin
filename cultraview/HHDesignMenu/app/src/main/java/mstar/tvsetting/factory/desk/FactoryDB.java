...
import mstar.tvsetting.factory.desk.IFactoryDesk.MS_NLA_VOLUME_POINT;
...
public class FactoryDB {
     ...
     * @return
     */
    public CtvPqlCalibrationData queryADCAdjust(int i) {
        Cursor cursor = getContentResolver().query(
                Uri.parse("content://mstar.tv.factory/adcadjust/sourceid/" + i), null, null, null,
                null);
        CtvPqlCalibrationData model = new CtvPqlCalibrationData();
    ...
    public void updateADCAdjust(CtvPqlCalibrationData model, int sourceId) {
        long ret = -1;
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_ADCAdjust_IDX);
    ...
    public MS_NLA_SETTING queryNonLinearAdjusts() {
        ...
        currentInputSource = CtvCommonManager.getInstance().getCurrentTvInputSource();

        Cursor cursor = getContentResolver().query(
                Uri.parse("content://mstar.tv.factory/nonlinearadjust"), null,
                "InputSrcType = " + currentInputSource, null, "CurveTypeIndex");
        int i = 0;
        ...
        cursor = getContentResolver().query(
                Uri.parse("content://mstar.tv.factory/nonlinearvolumeadjust/inputsrctype/"
                        + currentInputSource), null, null, null, null);
        if (cursor.moveToNext()) {
            model.nlavolumeSetting.u8OSD_V0 = cursor.getInt(cursor.getColumnIndex("u8OSD_V0"));
            model.nlavolumeSetting.u8OSD_V1 = cursor.getInt(cursor.getColumnIndex("u8OSD_V1"));
            model.nlavolumeSetting.u8OSD_V2 = cursor.getInt(cursor.getColumnIndex("u8OSD_V2"));
            model.nlavolumeSetting.u8OSD_V3 = cursor.getInt(cursor.getColumnIndex("u8OSD_V3"));
            model.nlavolumeSetting.u8OSD_V4 = cursor.getInt(cursor.getColumnIndex("u8OSD_V4"));
            model.nlavolumeSetting.u8OSD_V5 = cursor.getInt(cursor.getColumnIndex("u8OSD_V5"));
            model.nlavolumeSetting.u8OSD_V6 = cursor.getInt(cursor.getColumnIndex("u8OSD_V6"));
            model.nlavolumeSetting.u8OSD_V7 = cursor.getInt(cursor.getColumnIndex("u8OSD_V7"));
            model.nlavolumeSetting.u8OSD_V8 = cursor.getInt(cursor.getColumnIndex("u8OSD_V8"));
            model.nlavolumeSetting.u8OSD_V9 = cursor.getInt(cursor.getColumnIndex("u8OSD_V9"));
            model.nlavolumeSetting.u8OSD_V10 = cursor.getInt(cursor.getColumnIndex("u8OSD_V10"));
            model.nlavolumeSetting.u8OSD_V20 = cursor.getInt(cursor.getColumnIndex("u8OSD_V20"));
            model.nlavolumeSetting.u8OSD_V30 = cursor.getInt(cursor.getColumnIndex("u8OSD_V30"));
            model.nlavolumeSetting.u8OSD_V40 = cursor.getInt(cursor.getColumnIndex("u8OSD_V40"));
            model.nlavolumeSetting.u8OSD_V50 = cursor.getInt(cursor.getColumnIndex("u8OSD_V50"));
            model.nlavolumeSetting.u8OSD_V60 = cursor.getInt(cursor.getColumnIndex("u8OSD_V60"));
            model.nlavolumeSetting.u8OSD_V70 = cursor.getInt(cursor.getColumnIndex("u8OSD_V70"));
            model.nlavolumeSetting.u8OSD_V80 = cursor.getInt(cursor.getColumnIndex("u8OSD_V80"));
            model.nlavolumeSetting.u8OSD_V90 = cursor.getInt(cursor.getColumnIndex("u8OSD_V90"));
            model.nlavolumeSetting.u8OSD_V100 = cursor.getInt(cursor.getColumnIndex("u8OSD_V100"));
        }
        cursor.close();
        LogUtils.v(TAG, "-----u8OSD_V0--" + model.nlavolumeSetting.u8OSD_V0);
        return model;
    }

    public void updateNonLinearvolumeAdjust(MS_NLA_VOLUME_POINT dataModel, int curveTypeIndex) {
        long ret = -1;
        int currentInputSource;
        ContentValues vals = new ContentValues();
        vals.put("u8OSD_V0", dataModel.u8OSD_V0);
        vals.put("u8OSD_V1", dataModel.u8OSD_V1);
        vals.put("u8OSD_V2", dataModel.u8OSD_V2);
        vals.put("u8OSD_V3", dataModel.u8OSD_V3);
        vals.put("u8OSD_V4", dataModel.u8OSD_V4);
        vals.put("u8OSD_V5", dataModel.u8OSD_V5);
        vals.put("u8OSD_V6", dataModel.u8OSD_V6);
        vals.put("u8OSD_V7", dataModel.u8OSD_V7);
        vals.put("u8OSD_V8", dataModel.u8OSD_V8);
        vals.put("u8OSD_V9", dataModel.u8OSD_V9);
        vals.put("u8OSD_V10", dataModel.u8OSD_V10);
        vals.put("u8OSD_V20", dataModel.u8OSD_V20);
        vals.put("u8OSD_V30", dataModel.u8OSD_V30);
        vals.put("u8OSD_V40", dataModel.u8OSD_V40);
        vals.put("u8OSD_V50", dataModel.u8OSD_V50);
        vals.put("u8OSD_V60", dataModel.u8OSD_V60);
        vals.put("u8OSD_V70", dataModel.u8OSD_V70);
        vals.put("u8OSD_V80", dataModel.u8OSD_V80);
        vals.put("u8OSD_V90", dataModel.u8OSD_V90);
        vals.put("u8OSD_V100", dataModel.u8OSD_V100);
        try {
            currentInputSource = CtvCommonManager.getInstance().getCurrentTvInputSource();
            ret = getContentResolver().update(
                    Uri.parse("content://mstar.tv.factory/nonlinearvolumeadjust/inputsrctype/"
                            + currentInputSource), vals, null, null);
        } catch (SQLException e) {
        }
        if (ret == -1) {
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_NonLinearAdjust_IDX);
        } catch (CtvCommonException e) {
            e.printStackTrace();
        }
    }
        ...
        try {
            ...
            ret = getContentResolver().update(
                    Uri.parse("content://mstar.tv.factory/nonlinearadjust/inputsrctype/"
                            + currentInputSource + "/curvetypeindex/" + curveTypeIndex), vals,
                    null, null);
        } catch (SQLException e) {
        }
        if (ret == -1) {
     ...
     * @return
     */
    public CtvFactoryNsVdSet queryNoStandSet() {
        CtvFactoryNsVdSet model = new CtvFactoryNsVdSet();
        Cursor cursor = getContentResolver().query(
    ...
    public void updateNonStandardAdjust(CtvFactoryNsVdSet model) {
        long ret = -1;
        ContentValues vals = new ContentValues();
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_NonStarndardAdjust_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public MS_FACTORY_EXTERN_SETTING queryFactoryExtern() {
        ...
        if (cursor.moveToFirst()) {
            ...
            model.dtvAvAbnormalDelay = cursor.getInt(cursor.getColumnIndex("DtvAvAbnormalDelay")) == 0 ? false : true;
            ...
            // TODO: 2020/3/18 8386
//            model.energyBacklightVal = (int) cursor
//                    .getInt(cursor.getColumnIndex("energyBacklight"));
//            model.energyLogenable = cursor.getInt(cursor.getColumnIndex("energyLogenable")) == 0 ? false
//                    : true;
//            model.energyModeEnable = cursor.getInt(cursor.getColumnIndex("energyModeEnable")) == 0 ? false
//                    : true;
//            model.uiBrightness = (int) cursor.getInt(cursor.getColumnIndex("uiBrightness"));
//            model.uiContrast = (int) cursor.getInt(cursor.getColumnIndex("uiContrast"));
        }
        cursor.close();
        return model;
    }
    ...
    public void updateFactoryExtern(MS_FACTORY_EXTERN_SETTING model) {
        ...
        vals.put("energyBacklight", model.energyBacklightVal);
        vals.put("energyLogenable", model.energyLogenable);
        vals.put("energyModeEnable", model.energyModeEnable);
        vals.put("uiBrightness", model.uiBrightness);
        vals.put("uiContrast", model.uiContrast);
        try {
            ret = getContentResolver().update(
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_FactoryExtern_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public int queryArcMode(int inputSrcType) {
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (value) {
                case CtvPictureManager.PICTURE_MODE_GAME:
                    value = cursor.getInt(cursor.getColumnIndex("enGameModeARCType"));
                    break;
                case CtvPictureManager.PICTURE_MODE_AUTO:
                    value = cursor.getInt(cursor.getColumnIndex("enAutoModeARCType"));
                    break;
                case CtvPictureManager.PICTURE_MODE_PC:
    ...
    public void updateOverscanAdjust(int FactoryOverScanType, int arcMode,
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_OverscanAdjust_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void updateYPbPrOverscanAdjust(int FactoryOverScanType, int arcMode,
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_YPbPrOverscanSetting_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void updateHDMIOverscanAdjust(int FactoryOverScanType, int arcMode,
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_HDMIOverscanSetting_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void updateDTVOverscanAdjust(int FactoryOverScanType, int arcMode,
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_DTVOverscanSetting_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void updateATVOverscanAdjust(int FactoryOverScanType, int arcMode,
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_ATVOverscanSetting_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void updatePictureMode(int ePicMode, int inputSrcType) {
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_VideoSetting_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void updateSpeakerPreScale(String eSpeakerPreScale) {
        ...
        if (ret == -1) {
            LogUtils.e(TAG, "update tbl_SoundSetting field SpeakerPreScale ignored");
        }

        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_SoundSetting_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void updateColorTempIdx(int inputSrcType, int pictureModeType,
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_PicMode_Setting_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void updateFactoryColorTempData(T_MS_COLOR_TEMP_DATA model, int colorTmpId) {
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_FacrotyColorTemp_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
        ...
        for (int sourceIdx = 0; sourceIdx < EN_MS_COLOR_TEMP_INPUT_SOURCE.E_INPUT_SOURCE_NUM
            ...
            for (int colorTmpIdx = 0; colorTmpIdx < EN_MS_COLOR_TEMP.MS_COLOR_TEMP_NUM.ordinal(); colorTmpIdx++) {
                if (cursor.moveToNext()) {
                    ...
                    int test = model.astColorTempEx[colorTmpIdx][sourceIdx].redgain <<1;
                }
            }
            cursor.close();
        }
    ...
    public void updateFactoryColorTempExData(T_MS_COLOR_TEMPEX_DATA model, int sourceId,
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_FacrotyColorTempEx_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void updateUserSysSetting(USER_SETTING_FIELD field, int value) {
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_SystemSetting_IDX);
        } catch (CtvCommonException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void updateSelfAdaptiveLevel(int value, int inputSrcType) {
        ...
        try {
            CtvDatabaseManager.getInstance().setDatabaseDirtyByApplication(
                    IFactoryDesk.T_ThreeDVideoMode_IDX);
        } catch (CtvCommonException e) {
            e.printStackTrace();
        }
    }
