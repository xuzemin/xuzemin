...
# webview
-keepclassmembers class com.xx.xx.Activity$AppAndroid {
  public *;
}
...
#反射引用资源文件
-keep class com.**.IDHelper{*; }
-keep class com.**.ResourceHelper{*; }
...
#CrashHandler log
-keep class com.**.utils.CrashHandler {*;}
