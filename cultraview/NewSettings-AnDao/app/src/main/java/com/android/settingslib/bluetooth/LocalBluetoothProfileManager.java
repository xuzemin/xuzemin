...
public final class LocalBluetoothProfileManager {
    ...
    LocalBluetoothProfileManager(Context context,
        ...
        if (uuids != null) {
            // MStar Android Patch Begin
            updateLocalProfiles(uuids,false);
            // MStar Android Patch End
        }
...
//            if (mHfDeviceProfile== null) {
//                Log.d(TAG, "Adding local HfDevice profile");
//                mHfDeviceProfile = new HfDeviceProfile(mContext, mLocalAdapter,
//                        mDeviceManager, this);
//                addProfile(mHfDeviceProfile, HfDeviceProfile.NAME,
//                        BluetoothHfDevice.ACTION_CONNECTION_STATE_CHANGED);
//            }
//        } else if (mHfDeviceProfile != null) {
//                removeProfile(mHfDeviceProfile, HfDeviceProfile.NAME,
//                        BluetoothHfDevice.ACTION_CONNECTION_STATE_CHANGED);
//                mHfDeviceProfile.finalize();
//                mHfDeviceProfile =  null;
//            Log.w(TAG,
//                "Warning: HfDevice profile was previously added but the UUID is now missing.");
//        }
...
//        profile = mHfDeviceProfile;
    ...
    // MStar Android Patch Begin
//    HfDeviceProfile getHfDeviceProfile() {
//        return mHfDeviceProfile;
//    }
    // MStar Android Patch End
...
//                Log.d(TAG,"mHfDeviceProfile updated");
//                profiles.add(mHfDeviceProfile);
//                removedProfiles.remove(mHfDeviceProfile);
//            }
//        }
