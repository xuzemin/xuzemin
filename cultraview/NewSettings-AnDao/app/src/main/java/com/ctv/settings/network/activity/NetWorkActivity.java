...
import com.ctv.settings.network.holder.BluetoothViewHolder;
import com.ctv.settings.network.holder.PppoeViewHolder;
import com.ctv.settings.network.holder.ScreenHotSponViewHolder;
import com.ctv.settings.network.holder.WifiHotspotViewHolder;
import com.ctv.settings.network.holder.WireViewHolder;
        ...
        if (currentTag != 0) {
            switch (currentTag) {
                ...
                case NetUtils.WIFI_HOTSPOT:    //热点
                    setContentView(R.layout.page_wifi_hotspot_new);
