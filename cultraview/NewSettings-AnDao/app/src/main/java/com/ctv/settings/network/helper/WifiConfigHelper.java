...
//    }
    ...
    public static void forgetConfiguration(Context context, WifiConfiguration config) throws Exception {
        if (config == null) {
            L.d("------------- forget config = null ");
            return;
        }
        ...
        if (configuredNetworks == null) {
            if (DEBUG) Log.e(TAG, "failed to get configured networks");
            L.d("------------- forget failed to get configured networks ");
            return;
        }
        ...
        for (WifiConfiguration wc : configuredNetworks) {
            if (wc != null && wc.SSID != null && TextUtils.equals(wc.SSID, config.SSID)) {
//                wifiMan.forget(wc.networkId, listener);
                L.d("------------- forgot network config: " + wc.toString());
     ...
     */
    public static void forgetWifiNetwork(Context context) throws Exception {
