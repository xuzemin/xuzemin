...
/**
 * <b>NotFindUSBLayout</b> TODO Usb device when filling the page not found
 * <p>
 * 
 * <pre>
 *  <b>入口</b>(入口参数):
 ...
 * @since 1.0.0
 */
public class NotFindUSBLayout extends FrameLayout {

    /**
     * @param context Context
     */
    public NotFindUSBLayout(Context context) {
        super(context);
        initView();
    }

    public void initView() {
        LayoutInflater.from(getContext()).inflate(R.layout.not_find_usb, this);
    }
