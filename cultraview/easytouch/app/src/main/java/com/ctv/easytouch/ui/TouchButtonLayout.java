...
//                Intent intent = getContext().getPackageManager().getLaunchIntentForPackage("com.ctv.annotation");
//                if (intent != null) {
//                    Log.d(TAG, "打开批注中");
//                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                    getContext().startActivity(intent);
...
//                fsIntent.setComponent(new ComponentName("com.ctv.annotation",
//                        "com.ctv.annotation.activity.MainActivity"));
//                fsIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                getContext().startService(fsIntent);
                break;
            }
