...
-obfuscationdictionary proguard-jean.txt
#其中所有有效词都用作混淆类名
...
#-libraryjars libs/itextpdf5.4.3.jar
...
#keep tff-server start
-dontwarn com.toofifi.tffserver.**
...
#-keep class com.mphotool.whiteboard.active.**{
# *;
# }

 -keep class com.mphotool.whiteboard.view.menuviews.dialog.**{
  *;
  }
