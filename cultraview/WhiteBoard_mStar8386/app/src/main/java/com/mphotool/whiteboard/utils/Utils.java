...
public class Utils {
    ...
    public static String getSystemProperties(String key, String defaultValue) {
        try {
            ...
            String value = (String) get.invoke(systemProperties, key, defaultValue);
    ...
    public static Bitmap screenshot(int width, int height) {
        try {
            ...
            Method m = SurfaceControl.getDeclaredMethod("screenshot", int.class , int.class);

            return (Bitmap)m.invoke(SurfaceControl, width, height);
