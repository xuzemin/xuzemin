...
//    }
    ...
    public boolean setAudioSoundMode(int soundMode) throws RemoteException {
        boolean result = TvAudioManager.getInstance().setAudioSoundMode(soundMode);
        if(soundMode == TvAudioManager.SOUND_MODE_USER){
            int balance = Settings.System.getInt(mContext.getContentResolver(), "user_balance", HHTConstant.DEFAULT_MODE_BALANCE);
    ...
    public boolean setBalance(int balanceValue) throws RemoteException {
        Settings.System.putInt(mContext.getContentResolver(), "user_balance", balanceValue);
