...
public class HHTOpsService extends IHHTOps.Stub {
    ...
    public String getOpsStartMode() throws RemoteException {
        String mode = SystemProperties.get(HHTConstant.OPS_START_MODE, HHTOpsManager.MODE_OPS_ANY_CHANNEL);
    ...
    public boolean setOpsStartMode(String strName) throws RemoteException {
        if (TextUtils.equals(strName, HHTOpsManager.MODE_OPS_NONE)
            ...
            SystemProperties.set(HHTConstant.OPS_START_MODE, strName);
            return true;
        }
        return false;
    }
    ...
    @Override
    public boolean getOpsLockStatus() throws RemoteException {
        return Tools.getOpsLockStatus();
    }
}
