...
public interface IFactoryDesk {
    ...
    public static enum MAX_HDMI_Resolution_Info {
        ...
        E_HDMI2160P_60,
        // 4096x2160p_24
        E_HDMI_4096_2160p_24,
        // 4096x2160p_25
        E_HDMI_4096_2160p_25,
        // 4096x2160p_30
        E_HDMI_4096_2160p_30,
        // 4096x2160p_50
        E_HDMI_4096_2160p_50,
        // 3840x2160p_60
        E_HDMI_4096_2160p_60,
    ...
    public String[] MAPI_HASH_IP = {
            "BBE Digital", "BBE ViVA", "SRS TSXT", "SRS TSHD ", "VIQ", "VDS", "VSPK",
            "DTS Surround Sensation", "QSound QSurround", "ADV", "CV3", "DD", "DD+", "DDCO",
            "Dolby pulse", "DTS 2.0 ", "DTS TC", "Dolby_THD", "DTS_HD", "MPEG2", "MPEG2_HD",
            "MPEG4", "MPEG4_SD", "MPEG4_HD", "DivX HD", "DivX_DRM", "DivX Plus HD", "H.264",
            "RM/RMVB", "VC-1", "WMV", "WMDRM_PD", "WMDRM_ND", "AVS", "FLV", "DivX qMobile",
            "DivX Mobile", "DivX HT", "DivX HD", "DVB-C", "MVC", "PlayReady", "Leanback",
            "facebook", "SC1.2", "", "Netflix2.1", "Netflix3.1", "VUDU", "CN - CinemaNow(BestBuy)",
    ...
    // INI keys
    public static String SYS_INI_PATH = "/tvconfig/config/sys.ini";

    public static String PANEL_INI_KEY = "panel:m_pPanelName";

    public static String CUSTOMER_INI_KEY = "model:gModelName";

    public static String SWAP_PORT_KEY = "panel:m_bPanelSwapPort";

    public static String DUAL_PORT_KEY = "panel:m_bPanelDualPort";

    public static String TI_MODE_KEY = "panel:m_bPanelLVDS_TI_MODE";

    public static String BIT_MODE_KEY = "panel:m_ucTiBitMode";

    public static String POL_PWM_KEY = "panel:bPolPWM";

    public static String PANEL_DUAL_KEY = "panel:m_bPanelDualPort";

    public static String PANEL_INVH_SYNC_KEY = "panel:m_bPanelInvHSync";

    public static String PANEL_PWM_KEY = "panel:u32PeriodPWM";
    public static String PANEL_DIV_PWM_KEY = "panel:u16DivPWM";
    public static String pANEL_MAX_PWM_KEY = "panel:u16MaxPWMvalue";
    public static String pANEL_MIN_PWM_KEY = "panel:u16MinPWMvalue";

    public static String MIRROR_OSD_KEY = "MISC_MIRROR_CFG:MIRROR_OSD";

    public static String MIRROR_VIDEO_KEY = "MISC_MIRROR_CFG:MIRROR_VIDEO";

    public static String HDMI1_EDID_KEY = "HDMI_EDID_1:HDMI_EDID_File";

    public static String HDMI2_EDID_KEY = "HDMI_EDID_2:HDMI_EDID_File";

    public static String HDMI3_EDID_KEY = "HDMI_EDID_3:HDMI_EDID_File";

    public static String HDMI4_EDID_KEY = "HDMI_EDID_4:HDMI_EDID_File";

    public static String VGA_EDID_KEY = "VGA_EDID:VGA_EDID_File";
    ...
    public class MS_FACTORY_EXTERN_SETTING {
        ...
        public int energyBacklightVal;

        public boolean energyLogenable;

        public boolean energyModeEnable;

        public int uiBrightness;
        ...
        public MS_FACTORY_EXTERN_SETTING() {
            ...
            audioSifThreshold = 0;
            audioDspVersion = 0;
            energyBacklightVal = 30;
            energyLogenable = false;
            energyModeEnable = true;
            uiBrightness = 0;
            uiContrast = 0;
        }
    }
    ...
    /**
     * set ALL HDMI over scan horizontal size
     *
     * @param hSize
     * @return
     */
    ...
    /**
     * set ALL HDMI over scan horizontal position
     *
     * @param hPosition
     * @return
     */
    ...
    /**
     * set ALL HDMI over scan vertical size
     *
     * @param vSize
     * @return
     */
    ...
    public boolean setDRC(int audiodrcVal);
    ...
    public class MS_NLA_SETTING {
        ...
        // / volume 0~100
        public MS_NLA_VOLUME_POINT nlavolumeSetting;
        ...
        public MS_NLA_SETTING() {
            ...
            nlavolumeSetting = new MS_NLA_VOLUME_POINT();
        }
    }
    ...
    public class MS_NLA_VOLUME_POINT {
        public int u8OSD_V0;
        ...
        public int u8OSD_V10;

        public int u8OSD_V20;

        public int u8OSD_V30;

        public int u8OSD_V40;

        public int u8OSD_V50;

        public int u8OSD_V60;

        public int u8OSD_V70;

        public int u8OSD_V80;

        public int u8OSD_V90;

        public int u8OSD_V100;

        public MS_NLA_VOLUME_POINT() {
            u8OSD_V0 = 128;
            u8OSD_V1 = 128;
            u8OSD_V2 = 128;
            u8OSD_V3 = 128;
    ...
    public void setInputSource(int st);
    ...
    public void updateWbColorTempExData(CtvWbGainOffset wbGainOffset, int colorTmpId);
